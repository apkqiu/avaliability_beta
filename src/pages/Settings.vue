<template>
    ...
    <div class="form-check form-switch">
        <input class="form-check-input" type="checkbox" role="switch" :checked="load('adv_bg', 'true') === 'true'"
            @change="save('adv_bg', $event.target.checked)" />
        <label class="form-check-label" for="adv_bg">高级背景</label>
    </div>
    <br />
    <div class="mb-3 row" v-if="load('adv_bg', 'true') === 'false'">
    ...
    <div v-else>
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                ...
                <input class="form-control" type="file" v-if="load('imgbg', '') === 'custom'" @change="
                    upload($event.target);
                save('imgbg', 'custom');
                " accept="image/*" />
            </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-8">
                <input type="range" class="form-range" min="0" max="200" step="1" :value="bgbrightness"
                    @input="bgbrightness = $event.target.value" @change="
                        save('bgbrightness', $event.target.value, false);
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-8">
                <input type="range" class="form-range" min="0" max="100" step="1" :value="coloropacity"
                    @input="coloropacity = $event.target.value" @change="save('coloropacity', $event.target.value)" />
            </div>
            <div class="col-sm-2">
    ...
    <hr />
    <RouterLink to="/" class="btn btn-primary">返回</RouterLink>
</template>
<script setup>
