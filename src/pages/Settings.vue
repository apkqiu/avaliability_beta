<template>
    ...
    <div class="form-check form-switch">
        <input class="form-check-input" type="checkbox" role="switch" :checked="(current_valueset.adv_bg||load('adv_bg', 'true')) === 'true'"
    ...
    <div v-else>
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                ...
                <input class="form-control" type="file" v-if="(current_valueset.imgbg||load('imgbg', '')).startsWith('custom')" @change="
                    upload($event.target);
